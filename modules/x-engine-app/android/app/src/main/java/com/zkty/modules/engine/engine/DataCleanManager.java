...
public class DataCleanManager {
    ...
    /**
     * * 清除/data/data/com.xxx.xxx/files/x-engine-dir下的内容 * *
     *
     * @param context
     */
    public static void cleanDownloadFiles(Context context) {
        deleteFilesByDirectory(new File(context.getFilesDir(), "/x-engine-dir"));
    }
...
//        tCacheSize += getFolderSize(context.getFilesDir());
