...
//    [XENP(iDirectManager) addToTab:self uri:@"http://10.2.128.73:8080" params:@{@"hideNavbar":@TRUE}];
//
...
//    [XENP(iDirectManager) addToTab:self uri:@"microapp://todo" params:@{@"hideNavbar":@TRUE}];
    [XENP(iDirectManager) addToTab:self uri:@"omp://10.2.128.73:8080" params:@{@"hideNavbar":@TRUE}];
