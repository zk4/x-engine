...
if __name__ == "__main__":
    ...
    arr = os.listdir("..")
    exclude=[]
    include= ['x-engine-jsi-device', 'x-engine-jsi-direct', 'x-engine-jsi-localstorage', 'x-engine-jsi-globalstorage', 'x-engine-jsi-scan', 'x-engine-jsi-viewer', 'x-engine-jsi-share', 'x-engine-jsi-media','x-engine-jsi-broadcast','x-engine-jsi-geo','x-engine-jsi-dev','x-engine-jsi-enviroment','x-engine-jsi-browser']
    for d in arr:
        if d in include:
            # continue
