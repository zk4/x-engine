...
Pod::Spec.new do |s|
    ...
    s.homepage     = "https://github.com/zkty-team/x-engine-jsi-broadcast"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-jsi-broadcast.git',
  :tag => s.version.to_s }
