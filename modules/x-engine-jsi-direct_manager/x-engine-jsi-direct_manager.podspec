...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-jsi-direct_manager"
    s.version      = version
    ...
    s.homepage     = "https://github.com/zkty-team/x-engine-jsi-direct_manager"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-jsi-direct_manager.git',
  :tag => s.version.to_s }
