...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-jsi-enviroment"
    s.version      = version
    ...
    s.homepage     = "https://github.com/zkty-team/x-engine-jsi-enviroment"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-jsi-enviroment.git',
  :tag => s.version.to_s }
