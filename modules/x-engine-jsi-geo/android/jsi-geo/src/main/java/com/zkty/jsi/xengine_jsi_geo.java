...
// generated by x-cli, it will be overwrite eventually!
  ...
  class _0_com_zkty_jsi_geo_DTO {
    ...
    public _1_com_zkty_jsi_geo_DTO i;
  }
...
public void _nestedAnonymousObject(final CompletionHandler<_0_com_zkty_jsi_geo_DTO> handler);
public _0_com_zkty_jsi_geo_DTO _nestedAnonymousObject();
...
public void _namedObjectWithArgs(_3_com_zkty_jsi_geo_DTO dto, final CompletionHandler<_2_com_zkty_jsi_geo_DTO> handler);
public _2_com_zkty_jsi_geo_DTO _namedObjectWithArgs(_3_com_zkty_jsi_geo_DTO dto);
  }
    ...
    final public void nestedAnonymousObject(JSONObject jsonobj, final CompletionHandler<Object> handler) {
      _nestedAnonymousObject(new CompletionHandler<_0_com_zkty_jsi_geo_DTO>() {
        @Override
        public void complete(_0_com_zkty_jsi_geo_DTO retValue) { handler.complete(retValue); }
        @Override
        public void complete() { handler.complete(); }
        @Override
        public void setProgressData(_0_com_zkty_jsi_geo_DTO value) { handler.setProgressData(value); }
      });

    }
        @JavascriptInterface
        public _0_com_zkty_jsi_geo_DTO nestedAnonymousObject(JSONObject jsonobj) {
    ...
    final public void namedObjectWithArgs(JSONObject jsonobj, final CompletionHandler<Object> handler) {
      _3_com_zkty_jsi_geo_DTO dto= convert(jsonobj,_3_com_zkty_jsi_geo_DTO.class);
      _namedObjectWithArgs(dto, new CompletionHandler<_2_com_zkty_jsi_geo_DTO>() {
        @Override
        public void complete(_2_com_zkty_jsi_geo_DTO retValue) { handler.complete(retValue); }
        @Override
        public void complete() { handler.complete(); }
        @Override
        public void setProgressData(_2_com_zkty_jsi_geo_DTO value) { handler.setProgressData(value); }
      });

    }
        @JavascriptInterface
        public _2_com_zkty_jsi_geo_DTO namedObjectWithArgs(JSONObject jsonobj) {
          _3_com_zkty_jsi_geo_DTO dto= convert(jsonobj,_3_com_zkty_jsi_geo_DTO.class);
