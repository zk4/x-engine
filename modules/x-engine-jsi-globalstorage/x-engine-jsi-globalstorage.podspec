...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-jsi-globalstorage"
    s.version      = version
    ...
    s.homepage     = "https://github.com/zkty-team/x-engine-jsi-globalstorage"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-jsi-globalstorage.git',
  :tag => s.version.to_s }
