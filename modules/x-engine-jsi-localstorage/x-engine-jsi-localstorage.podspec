...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-jsi-localstorage"
    s.version      = version
    ...
    s.homepage     = "https://github.com/zkty-team/x-engine-jsi-localstorage"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-jsi-localstorage.git',
  :tag => s.version.to_s }
