...
// generated by x-cli, it will be overwrite eventually!
  ...
  class _0_com_zkty_jsi_webcache_DTO {
    public String a;

    public _1_com_zkty_jsi_webcache_DTO i;
  }
  
  class _1_com_zkty_jsi_webcache_DTO {
    public String n1;
  }
  
  class _2_com_zkty_jsi_webcache_DTO {
    public String goodname;

    public Integer price;
  }
  
  class _3_com_zkty_jsi_webcache_DTO {
    public String name;
...
public void _nestedAnonymousObject(final CompletionHandler<_0_com_zkty_jsi_webcache_DTO> handler);
public _0_com_zkty_jsi_webcache_DTO _nestedAnonymousObject();
...
public void _namedObjectWithArgs(_3_com_zkty_jsi_webcache_DTO dto, final CompletionHandler<_2_com_zkty_jsi_webcache_DTO> handler);
public _2_com_zkty_jsi_webcache_DTO _namedObjectWithArgs(_3_com_zkty_jsi_webcache_DTO dto);
  }
    ...
    final public void nestedAnonymousObject(JSONObject jsonobj, final CompletionHandler<Object> handler) {
      _nestedAnonymousObject(new CompletionHandler<_0_com_zkty_jsi_webcache_DTO>() {
        @Override
        public void complete(_0_com_zkty_jsi_webcache_DTO retValue) { handler.complete(retValue); }
        @Override
        public void complete() { handler.complete(); }
        @Override
        public void setProgressData(_0_com_zkty_jsi_webcache_DTO value) { handler.setProgressData(value); }
      });

    }
        @JavascriptInterface
        public _0_com_zkty_jsi_webcache_DTO nestedAnonymousObject(JSONObject jsonobj) {
    ...
    final public void namedObjectWithArgs(JSONObject jsonobj, final CompletionHandler<Object> handler) {
      _3_com_zkty_jsi_webcache_DTO dto= convert(jsonobj,_3_com_zkty_jsi_webcache_DTO.class);
      _namedObjectWithArgs(dto, new CompletionHandler<_2_com_zkty_jsi_webcache_DTO>() {
        @Override
        public void complete(_2_com_zkty_jsi_webcache_DTO retValue) { handler.complete(retValue); }
        @Override
        public void complete() { handler.complete(); }
        @Override
        public void setProgressData(_2_com_zkty_jsi_webcache_DTO value) { handler.setProgressData(value); }
      });

    }
        @JavascriptInterface
        public _2_com_zkty_jsi_webcache_DTO namedObjectWithArgs(JSONObject jsonobj) {
          _3_com_zkty_jsi_webcache_DTO dto= convert(jsonobj,_3_com_zkty_jsi_webcache_DTO.class);
