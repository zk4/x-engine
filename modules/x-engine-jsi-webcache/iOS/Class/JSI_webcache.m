...
- (_0_com_zkty_jsi_webcache_DTO *)_nestedAnonymousObject {
    _0_com_zkty_jsi_webcache_DTO * ret =[_0_com_zkty_jsi_webcache_DTO new];
    ret.a=@"hello";
    ret.i =[_1_com_zkty_jsi_webcache_DTO new];
    ret.i.n1=@"_nestedAnonymousObject sync";
    return ret;
}


- (void)_nestedAnonymousObject:(void (^)(_0_com_zkty_jsi_webcache_DTO *, BOOL))completionHandler {
    _0_com_zkty_jsi_webcache_DTO * ret =[_0_com_zkty_jsi_webcache_DTO new];
    ret.a=@"hello";
    ret.i =[_1_com_zkty_jsi_webcache_DTO new];
