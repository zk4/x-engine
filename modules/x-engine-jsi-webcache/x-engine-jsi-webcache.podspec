...
Pod::Spec.new do |s|
    ...
    s.homepage     = "https://github.com/zkty-team/x-engine-jsi-webcache"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-jsi-webcache.git',
  :tag => s.version.to_s }
    ...
    s.dependency "x-engine-native-net"
