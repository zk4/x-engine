...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-module-bluetooth"
    s.version      = "0.0.1"
    s.summary      = "summary of x-engine-module-bluetooth"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-module-bluetooth"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-module-bluetooth.git',
  :tag => s.version.to_s }
