...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].engine = _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].ui || {};

_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].engine.showActionSheet = function (args) {
  const alertConfig = {
  ...
  return new Promise(function (resolve, reject) {
    try {
      ...
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.engine.showActionSheet", JSON.stringify(str), function (res) {
        resolve(res);
      });
    } catch (error) {
      reject(error);
