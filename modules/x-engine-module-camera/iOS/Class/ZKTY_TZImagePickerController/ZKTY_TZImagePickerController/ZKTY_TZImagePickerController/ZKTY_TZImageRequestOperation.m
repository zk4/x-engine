//
//  ZKTY_TZImageRequestOperation.m
...
@implementation ZKTY_TZImageRequestOperation
...
- (void)start {
    self.executing = YES;
    [[ZKTY_TZImageManager manager] getPhotoWithAsset:self.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
