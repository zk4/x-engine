...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].geo = _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].geo || {};

_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].geo.showActionSheet = function (args) {
  const alertConfig = {
  ...
  return new Promise(function (resolve, reject) {
    try {
      ...
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.geo.showActionSheet", JSON.stringify(str), function (res) {
        resolve(res);
      });
    } catch (error) {
      reject(error);
...
/* harmony default export */ __webpack_exports__["default"] = (_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].geo);
