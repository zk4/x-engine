...
@class ContinousDTO;
@class MsgPayloadDTO;
@class _0_com_zkty_module_microapp_DTO;
@class _1_com_zkty_module_microapp_DTO;
@class _2_com_zkty_module_microapp_DTO;
@class _3_com_zkty_module_microapp_DTO;
...
@interface _0_com_zkty_module_microapp_DTO: JSONModel
  	@property(nonatomic,assign) NSInteger age;
   	@property(nonatomic,copy) NSString* name;
   	@property(nonatomic,strong) NSArray<NSString*>* books;
   	@property(nonatomic,strong) _1_com_zkty_module_microapp_DTO* complexArg;
@end
    

@interface _1_com_zkty_module_microapp_DTO: JSONModel
  	@property(nonatomic,assign) NSInteger a;
   	@property(nonatomic,copy) NSString* name;
@end
    

@interface _2_com_zkty_module_microapp_DTO: JSONModel
  	@property(nonatomic,assign) NSInteger age;
   	@property(nonatomic,copy) NSString* name;
   	@property(nonatomic,strong) NSArray<NSString*>* books;
   	@property(nonatomic,strong) _3_com_zkty_module_microapp_DTO* complexArg;
@end
    

@interface _3_com_zkty_module_microapp_DTO: JSONModel
  	@property(nonatomic,assign) NSInteger a;
   	@property(nonatomic,copy) NSString* name;
@end
...
@protocol xengine__module_microapp_protocol
      ...
      @required 
        - (void) _anonymousType:(_2_com_zkty_module_microapp_DTO*) dto complete:(void (^)(_0_com_zkty_module_microapp_DTO* result,BOOL complete)) completionHandler;
