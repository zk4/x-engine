...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-module-microapp"
    s.version      = "1.0.0"
    s.summary      = "summary of x-engine-module-microapp"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-module-microapp"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-module-microapp.git',
  :tag => s.version.to_s }
