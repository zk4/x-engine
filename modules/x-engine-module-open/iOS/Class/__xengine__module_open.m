...
#import "__xengine__module_open.h"
...
@interface __xengine__module_open()
{
    NSTimer * timer ;
    ContinousDTO* adto;
...
@implementation __xengine__module_open
...
- (void)_anonymousType:(_2_com_zkty_module_open_DTO *)dto complete:(void (^)(_0_com_zkty_module_open_DTO *, BOOL))completionHandler {
