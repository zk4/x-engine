...
@protocol _0_com_zkty_module_open_DTO;
@protocol _1_com_zkty_module_open_DTO;
@protocol _2_com_zkty_module_open_DTO;
@protocol _3_com_zkty_module_open_DTO;
@class _1_com_zkty_module_open_DTO;
@class _3_com_zkty_module_open_DTO;
...
@interface _0_com_zkty_module_open_DTO: JSONModel
  	@property(nonatomic,assign) NSInteger age;
   	@property(nonatomic,copy) NSString* name;
   	@property(nonatomic,strong) NSArray<NSString*>* books;
   	@property(nonatomic,strong) _1_com_zkty_module_open_DTO* complexArg;
@end
    

@interface _1_com_zkty_module_open_DTO: JSONModel
  	@property(nonatomic,assign) NSInteger a;
   	@property(nonatomic,copy) NSString* name;
@end
    

@interface _2_com_zkty_module_open_DTO: JSONModel
  	@property(nonatomic,assign) NSInteger age;
   	@property(nonatomic,copy) NSString* name;
   	@property(nonatomic,strong) NSArray<NSString*>* books;
   	@property(nonatomic,strong) _3_com_zkty_module_open_DTO* complexArg;
@end
    

@interface _3_com_zkty_module_open_DTO: JSONModel
  	@property(nonatomic,assign) NSInteger a;
   	@property(nonatomic,copy) NSString* name;
@end
...
@protocol xengine__module_open_protocol
       @required 
      ...
      @required 
        - (void) _anonymousType:(_2_com_zkty_module_open_DTO*) dto complete:(void (^)(_0_com_zkty_module_open_DTO* result,BOOL complete)) completionHandler;

@end
  


@interface xengine__module_open : xengine__module_BaseModule<xengine__module_open_protocol>
@end
