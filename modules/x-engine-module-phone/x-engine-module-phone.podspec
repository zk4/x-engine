...
Pod::Spec.new do |s|
    ...
    s.homepage     = "https://github.com/zkty-team/x-engine-module-phone"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-module-phone.git',
  :tag => s.version.to_s }
