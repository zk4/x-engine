...
public class RouterMaster {
    ...
    public static void openTargetRouter(Context context, String type, String uri, String path) {
        ...
        switch (type) {
            case "h5"://h5
                ...
                break;
            case "microapp"://微应用
                XEngineWebActivityManager.sharedInstance().startXEngineActivity(context, uri, path);
                break;
            case "wx"://微信小程序
                String appId = null;
                try {
