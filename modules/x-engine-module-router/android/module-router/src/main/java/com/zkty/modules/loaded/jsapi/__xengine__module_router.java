...
public class __xengine__module_router extends xengine__module_router {
    ...
    public void _openTargetRouter(RouterOpenAppDTO dto, CompletionHandler<Nullable> handler) {
        ...
        RouterAspect.openTargetRouter(dto.type, dto.uri, dto.path, dto.args == null ? null : JSON.toJSONString(dto.args), dto.version == null ? null : String.valueOf(dto.version), dto.hideNavbar);
        handler.complete();
    }
}
