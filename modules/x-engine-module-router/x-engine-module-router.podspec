...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-module-router"
    s.version      = version
    s.summary      = "summary of x-engine-module-router"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-module-router"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-module-router.git',
  :tag => s.version.to_s }
