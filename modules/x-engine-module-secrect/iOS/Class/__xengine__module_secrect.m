...
#import "__xengine__module_secrect.h"
...
@interface __xengine__module_secrect()
{
    NSTimer * timer ;
    ContinousDTO* adto;
...
@implementation __xengine__module_secrect
...
- (void)_anonymousType:(_2_com_zkty_module_secrect_DTO *)dto complete:(void (^)(_0_com_zkty_module_secrect_DTO *, BOOL))completionHandler {
