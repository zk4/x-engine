...
@implementation _0_com_zkty_module_secrect_DTO
...
@implementation _1_com_zkty_module_secrect_DTO
    + (BOOL)propertyIsOptional:(NSString *)propertyName {
   	return NO;
    }
@end
...
@implementation _2_com_zkty_module_secrect_DTO
    + (BOOL)propertyIsOptional:(NSString *)propertyName {	if ([propertyName isEqualToString:@"age"]) { return YES; }
   	if ([propertyName isEqualToString:@"name"]) { return YES; }
   	if ([propertyName isEqualToString:@"books"]) { return YES; }
   	if ([propertyName isEqualToString:@"complexArg"]) { return YES; }	return NO;
...
@implementation _3_com_zkty_module_secrect_DTO
    + (BOOL)propertyIsOptional:(NSString *)propertyName {
   	return NO;
    }
@end
  ...
  @implementation xengine__module_secrect
    ...
    - (void) anonymousType:(NSDictionary*) dict complete:(XEngineCallBack)completionHandler {
          ...
          _2_com_zkty_module_secrect_DTO* dto = [self convert:dict clazz:_2_com_zkty_module_secrect_DTO.class];
          [self _anonymousType:dto complete:^(_0_com_zkty_module_secrect_DTO* result,  BOOL complete) {
            completionHandler(result,complete);
          }];
