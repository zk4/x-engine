...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-module-secrect"
    s.version      = version
    ...
    s.homepage     = "https://github.com/zkty-team/x-engine-module-secrect"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-module-secrect.git',
  :tag => s.version.to_s }
