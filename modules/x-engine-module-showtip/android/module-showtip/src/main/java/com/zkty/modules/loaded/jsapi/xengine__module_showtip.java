...
// generated by x-cli, it will be overwrite eventually!
  ...
  class _0_com_zkty_module_showtip_DTO {
    @Optional
		public Integer age;
    ...
    @Optional
		public _1_com_zkty_module_showtip_DTO complexArg;
  }
  
  class _1_com_zkty_module_showtip_DTO {
    public Integer a;

    public String name;
  }
  
  class _2_com_zkty_module_showtip_DTO {
    @Optional
		public Integer age;
    ...
    @Optional
		public _3_com_zkty_module_showtip_DTO complexArg;
  }
  
  class _3_com_zkty_module_showtip_DTO {
    public Integer a;

    public String name;
  }
  
  interface xengine__module_showtip_i {
...
public void _anonymousType(_2_com_zkty_module_showtip_DTO dto, final CompletionHandler<_0_com_zkty_module_showtip_DTO> handler);
  }
  
  
  public abstract class xengine__module_showtip extends xengine__module_BaseModule implements xengine__module_showtip_i {
    @Override
    public String moduleId() {
      return "com.zkty.module.showtip";
    }
    ...
    final public void anonymousType(JSONObject obj, final CompletionHandler<Object> handler) {
      _2_com_zkty_module_showtip_DTO data= convert(obj,_2_com_zkty_module_showtip_DTO.class);
      _anonymousType(data, new CompletionHandler<_0_com_zkty_module_showtip_DTO>() {
        @Override
        public void complete(_0_com_zkty_module_showtip_DTO retValue) { handler.complete(retValue); }
        @Override
        public void complete() { handler.complete(); }
        @Override
        public void setProgressData(_0_com_zkty_module_showtip_DTO value) { handler.setProgressData(value); }
      });
