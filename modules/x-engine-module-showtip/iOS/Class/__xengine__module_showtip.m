...
#import "__xengine__module_showtip.h"
...
@interface __xengine__module_showtip()
{
    NSTimer * timer ;
    ContinousDTO* adto;
...
@implementation __xengine__module_showtip
...
- (void)_anonymousType:(_2_com_zkty_module_showtip_DTO *)dto complete:(void (^)(_0_com_zkty_module_showtip_DTO *, BOOL))completionHandler {
