...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-module-showtip"
    s.version      = version
    ...
    s.homepage     = "https://github.com/zkty-team/x-engine-module-showtip"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-module-showtip.git',
  :tag => s.version.to_s }
