...
Pod::Spec.new do |s|
    ...
    s.homepage     = "https://github.com/zkty-team/x-engine-module-tzcash"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-module-tzcash.git',
  :tag => s.version.to_s }
