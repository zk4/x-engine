...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "90942f293e0664f4f51d";
...
xengine.platfrom = getPlatform();

Object.defineProperty(xengine, "bridge", {
  get(){
    return dsbridge__WEBPACK_IMPORTED_MODULE_0___default.a;
  },
  set: function () {
    throw('dsbridge不能被修改')
  }
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].ui.showLoading = function (args) {
  if (!args) {
    alert("showLoading参数不正确");
  } else {
    if (args.hasOwnProperty("title") && args.title.length != 0) {
      const loadingConfig = {};
      const obj = { ...loadingConfig,
        ...args
      };
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.ui.showLoading", obj, res => {
        console.log(res);
      });
    } else {
      alert("showLoading参数不正确");
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].ui.hideLoading = function () {
  dsBridge.call("com.zkty.module.ui.hideLoading", null, res => {
    resolve(res);
  });
};
/*
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].ui.showActionSheet = function (args) {
  ...
  return new Promise(function (resolve, reject) {
    try {
      if (!args) {
        alert("showActionSheet参数不正确");
      } else {
        if (args.hasOwnProperty("itemList") && args.itemList.length != 0) {
          const obj = { ...alertConfig,
            ...args
          };
          _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.ui.showActionSheet", obj, res => {
          ...
          if (args.hasOwnProperty('fail')) {
            args.fail("showActionSheet参数不正确");
          } else {
            reject("showActionSheet参数不正确");
          }
        }
      }
    } catch (error) {}
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].ui.showModal = function (args) {
  const modalConfig = {
    showCancel: 'false'
  };
  return new Promise(function (resolve, reject) {
    try {
      if (!args) {
        alert("showModal参数不正确");
      } else {
        if (args.hasOwnProperty('title') && args.title.length != 0) {
          const str = { ...modalConfig,
            ...args
          };
          _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.ui.showModal", str, res => {
            if (args.hasOwnProperty('success')) {
              args.success(JSON.parse(res));
            } else {
              resolve(JSON.parse(res));
          ...
          if (args.hasOwnProperty('fail')) {
            args.fail("showModal参数不正确");
          } else {
            reject("showModal参数不正确");
          }
        }
      }
    } catch (error) {}
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].ui.showToast = function (args) {
  const toastConfig = {
    duration: 2000
  };
  return new Promise(function (resolve, reject) {
    try {
      if (!args) {
        alert("showToast参数不正确");
      } else {
        if (args.hasOwnProperty("title") && args.title.length != 0) {
          const obj = { ...toastConfig,
            ...args
          };
          _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.ui.showToast", obj, res => {
            if (args.hasOwnProperty('success')) {
              args.success(JSON.parse(res));
            } else {
              resolve(JSON.parse(res));
          ...
          if (args.hasOwnProperty('fail')) {
            args.fail("showToast参数不正确");
          } else {
            reject("showToast参数不正确");
          }
        }
      }
    } catch (error) {}
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].ui.hideToast = function (args) {
  dsBridge.call("com.zkty.module.ui.hideToast", '', res => {});
};

_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].ui.showPickerView = function (args) {
  const pickerViewConfig = {
    cancelText: "取消",
    cancelTextColor: "",
    enterText: "确定",
    enterTextColor: "blue" // pickerBackgroundColor: "#f7f7f7",
    // toolBarBackgroundColor:"#dcdcdc",
  ...
  return new Promise(function (resolve, reject) {
    try {
      if (!args) {
        alert("showPickerView参数不正确");
      } else {
        const str = { ...pickerViewConfig,
          ...args
        };
        _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.ui.showPickerView", str, res => {
          if (args.hasOwnProperty('success')) {
            args.success(JSON.parse(res));
          } else {
            resolve(JSON.parse(res));
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].ui.handlerPickerViewEnter = function (args) {
  return new Promise(function (resolve, reject) {
    try {
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.register('handlerPickerViewEnter', res => {
        if (args.hasOwnProperty('success')) {
          args.success(JSON.parse(res));
        } else {
          resolve(JSON.parse(res));
...
__webpack_require__(/*! /Users/edz/code/zkty/modules/x-engine-module-ui/h5/node_modules/vconsole-webpack-plugin/src/vconsole.js */"./node_modules/vconsole-webpack-plugin/src/vconsole.js");
