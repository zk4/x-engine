...
public class BottomDialog implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    public BottomDialog(Context context) {
        ...
        view = mLayoutInflater.inflate(R.layout.bottom_dialog_content_view, null);
    ...
    public void initDialog(String title, String content, String[] items, BottomDialogOnClickListener listener) {
    ...
    public class MyListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            View view1 = mLayoutInflater.inflate(R.layout.bottom_dialog_item, null);
            TextView tvContent1 = view1.findViewById(R.id.tv_content);
            String title = mArr[i];
            tvContent1.setText(title);
            if (i == selected) {
                tvContent1.setTextColor(mContext.getResources().getColor(R.color.color_E8374A));
            }
