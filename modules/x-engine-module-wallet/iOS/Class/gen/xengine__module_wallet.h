...
@class ContinousDTO;
@class MsgPayloadDTO;
@class _0_com_zkty_module_wallet_DTO;
@class _1_com_zkty_module_wallet_DTO;
@class _2_com_zkty_module_wallet_DTO;
@class _3_com_zkty_module_wallet_DTO;
...
@interface _0_com_zkty_module_wallet_DTO: JSONModel
  	@property(nonatomic,assign) NSInteger age;
   	@property(nonatomic,copy) NSString* name;
   	@property(nonatomic,strong) NSArray<NSString*>* books;
   	@property(nonatomic,strong) _1_com_zkty_module_wallet_DTO* complexArg;
@end
    

@interface _1_com_zkty_module_wallet_DTO: JSONModel
  	@property(nonatomic,assign) NSInteger a;
   	@property(nonatomic,copy) NSString* name;
@end
    

@interface _2_com_zkty_module_wallet_DTO: JSONModel
  	@property(nonatomic,assign) NSInteger age;
   	@property(nonatomic,copy) NSString* name;
   	@property(nonatomic,strong) NSArray<NSString*>* books;
   	@property(nonatomic,strong) _3_com_zkty_module_wallet_DTO* complexArg;
@end
    

@interface _3_com_zkty_module_wallet_DTO: JSONModel
  	@property(nonatomic,assign) NSInteger a;
   	@property(nonatomic,copy) NSString* name;
@end
...
@protocol xengine__module_wallet_protocol
      ...
      @required 
        - (void) _anonymousType:(_2_com_zkty_module_wallet_DTO*) dto complete:(void (^)(_0_com_zkty_module_wallet_DTO* result,BOOL complete)) completionHandler;
