...
Pod::Spec.new do |s|
    ...
    s.homepage     = "https://github.com/zkty-team/x-engine-module-wallet"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-module-wallet.git',
  :tag => s.version.to_s }
