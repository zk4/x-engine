...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-broadcast"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-broadcast"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-broadcast"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-broadcast.git',
  :tag => s.version.to_s }
