...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-browser"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-browser"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-browser"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-browser.git',
  :tag => s.version.to_s }
