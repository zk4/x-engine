...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-cache"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-cache"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-cache"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-cache.git',
  :tag => s.version.to_s }
