//
//  ZKTY_TZVideoPlayerController.m
...
@interface ZKTY_TZVideoPlayerController () {
    AVPlayer *_player;
...
@implementation ZKTY_TZVideoPlayerController
...
- (void)configMoviePlayer {
    [[ZKTY_TZImageManager manager] getPhotoWithAsset:_model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
...
- (UIView *)iCloudErrorView{
    if (!_iCloudErrorView) {
        _iCloudErrorView = [[UIView alloc] initWithFrame:CGRectMake(0, [ZKTY_TZCommonTools tz_statusBarHeight] + 44 + 10, self.view.tz_width, 28)];
