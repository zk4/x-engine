...
+ (void)showOscillatoryAnimationWithLayer:(CALayer *)layer type:(ZKTY_TZOscillatoryAnimationType)type{
    NSNumber *animationScale1 = type == ZKTY_TZOscillatoryAnimationToBigger ? @(1.15) : @(0.5);
    NSNumber *animationScale2 = type == ZKTY_TZOscillatoryAnimationToBigger ? @(0.92) : @(1.15);
