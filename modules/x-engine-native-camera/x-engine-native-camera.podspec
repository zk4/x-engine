...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-camera"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-camera"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-camera"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-camera.git',
  :tag => s.version.to_s }
