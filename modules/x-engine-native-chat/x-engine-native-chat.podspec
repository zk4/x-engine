...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-chat"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-chat"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-chat"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-chat.git',
  :tag => s.version.to_s }
