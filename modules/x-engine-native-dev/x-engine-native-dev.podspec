...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-dev"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-dev"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-dev"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-dev.git',
  :tag => s.version.to_s }
