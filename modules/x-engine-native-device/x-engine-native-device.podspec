...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-device"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-device"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-device"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-device.git',
  :tag => s.version.to_s }
