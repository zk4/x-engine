...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-direct"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-direct"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-direct"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-direct.git',
  :tag => s.version.to_s }
