...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-direct_http"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-direct_http"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-direct_http"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-direct_http.git',
  :tag => s.version.to_s }
