...
#
#  To lealrn more about Podspec attributes see https://guides.cocoapods.org/syntax/podspec.html
...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-direct_lrn"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-direct_lrn"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-direct_lrn"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-direct_lrn.git',
  :tag => s.version.to_s }
