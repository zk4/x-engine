...
@interface Native_direct_omps()
@end
@implementation Native_direct_omps
NATIVE_MODULE(Native_direct_omps)
...
- (nonnull UIViewController *)getContainer:(nonnull NSString *)protocol host:(nullable NSString *)host pathname:(nonnull NSString *)pathname fragment:(nullable NSString *)fragment query:(nullable NSDictionary<NSString *,id> *)query params:(nullable NSDictionary<NSString *,id> *)params frame:(CGRect)frame {
    ...
    BOOL isShowWebView = [[nativeParams objectForKey:@"webView"] boolValue];

    RecyleWebViewController *vc =  [[RecyleWebViewController alloc] initWithUrl:finalUrl  withHiddenNavBar:isHideNavBar webviewFrame:frame looseNetwork:isLooseNetwork webView:isShowWebView];
