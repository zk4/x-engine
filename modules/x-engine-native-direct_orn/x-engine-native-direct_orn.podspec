...
#
#  To leaorn more about Podspec attributes see https://guides.cocoapods.org/syntax/podspec.html
...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-direct_orn"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-direct_orn"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-direct_orn"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-direct_orn.git',
  :tag => s.version.to_s }
