...
#
#  To leaorns more about Podspec attributes see https://guides.cocoapods.org/syntax/podspec.html
...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-direct_orns"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-direct_orns"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-direct_orns"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-direct_orns.git',
  :tag => s.version.to_s }
