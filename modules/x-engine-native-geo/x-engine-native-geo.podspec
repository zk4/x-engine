...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-geo"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-geo"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-geo"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-geo.git',
  :tag => s.version.to_s }
