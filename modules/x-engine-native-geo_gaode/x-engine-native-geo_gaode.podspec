...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-geo_gaode"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-geo_gaode"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-geo_gaode"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-geo_gaode.git',
  :tag => s.version.to_s }
    ...
    s.dependency "x-engine-native-toast"
