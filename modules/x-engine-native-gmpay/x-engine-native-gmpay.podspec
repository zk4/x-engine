...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-gmpay"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-gmpay"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-gmpay"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-gmpay.git',
  :tag => s.version.to_s }
