...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-gmupload"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-gmupload"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-gmupload"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-gmupload.git',
  :tag => s.version.to_s }
