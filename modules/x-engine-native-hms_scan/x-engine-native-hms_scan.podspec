...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-hms_scan"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-hms_scan"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-hms_scan"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-hms_scan.git',
  :tag => s.version.to_s }
