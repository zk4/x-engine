...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-hummer"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-hummer"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-hummer"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-hummer.git',
  :tag => s.version.to_s }
