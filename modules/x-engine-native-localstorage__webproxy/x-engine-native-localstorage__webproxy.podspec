...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-localstorage__webproxy"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-localstorage__webproxy"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-localstorage__webproxy"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-localstorage__webproxy.git',
  :tag => s.version.to_s }
