...
@interface ZKTY_TZLocationManager ()<CLLocationManagerDelegate>
...
@implementation ZKTY_TZLocationManager

+ (instancetype)manager {
    static ZKTY_TZLocationManager *manager;
