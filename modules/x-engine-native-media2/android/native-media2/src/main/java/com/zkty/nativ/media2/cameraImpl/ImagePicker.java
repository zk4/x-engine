package com.zkty.nativ.media2.cameraImpl;

import android.app.Activity;
import android.content.Intent;

import com.zkty.nativ.media2.cameraImpl.activity.ImagePickerActivity;
import com.zkty.nativ.media2.cameraImpl.manager.ConfigManager;
import com.zkty.nativ.media2.cameraImpl.utils.ImageLoader;
...
public class ImagePicker {
     ...
     * @return
     */
    public ImagePicker setRearCamera(boolean rear) {
        ConfigManager.getInstance().setRearCamera(rear);
        return mImagePicker;
    }
