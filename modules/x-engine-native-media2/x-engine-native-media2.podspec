...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-media2"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-media2"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-media2"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-media2.git',
  :tag => s.version.to_s }
