...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-net"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-net"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-net"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-net.git',
  :tag => s.version.to_s }
