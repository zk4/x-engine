...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-network"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-network"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-network"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-network.git',
  :tag => s.version.to_s }
