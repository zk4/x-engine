...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-networkmanager"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-networkmanager"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-networkmanager"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-networkmanager.git',
  :tag => s.version.to_s }
