...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-offline"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-offline"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-offline"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-offline.git',
  :tag => s.version.to_s }
