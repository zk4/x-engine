...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-rest"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-rest"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-rest"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-rest.git',
  :tag => s.version.to_s }
