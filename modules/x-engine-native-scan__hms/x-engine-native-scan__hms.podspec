...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-scan__hms"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-scan__hms"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-scan__hms"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-scan__hms.git',
  :tag => s.version.to_s }
