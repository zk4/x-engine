...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-share"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-share"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-share"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-share.git',
  :tag => s.version.to_s }
