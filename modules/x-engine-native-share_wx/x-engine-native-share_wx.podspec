...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-share_wx"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-share_wx"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-share_wx"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-share_wx.git',
  :tag => s.version.to_s }
