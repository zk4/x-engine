...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-store"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-store"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-store"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-store.git',
  :tag => s.version.to_s }
