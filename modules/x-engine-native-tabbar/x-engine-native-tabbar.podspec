...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-tabbar"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-tabbar"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-tabbar"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-tabbar.git',
  :tag => s.version.to_s }
