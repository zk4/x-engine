...
Pod::Spec.new do |s|
    ...
    s.homepage     = "https://github.com/zkty-team/x-engine-native-xxxx"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-xxxx.git',
  :tag => s.version.to_s }
    ...
    s.dependency "x-engine-module-core"
