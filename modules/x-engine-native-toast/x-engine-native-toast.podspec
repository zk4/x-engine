...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-toast"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-toast"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-toast"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-toast.git',
  :tag => s.version.to_s }
