...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-updator"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-updator"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-updator"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-updator.git',
  :tag => s.version.to_s }
