...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-viewer-orgi"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-viewer-orgi"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-viewer-orgi"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-viewer-orgi.git',
  :tag => s.version.to_s }
