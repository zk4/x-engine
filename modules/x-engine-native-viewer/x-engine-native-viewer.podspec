...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-viewer"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-viewer"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-viewer"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-viewer.git',
  :tag => s.version.to_s }
