...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-viewer_orgi"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-viewer_orgi"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-viewer_orgi"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-viewer_orgi.git',
  :tag => s.version.to_s }
