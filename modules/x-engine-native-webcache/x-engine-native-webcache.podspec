...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-native-webcache"
    s.version      = "1.0.0"
    s.summary      = "x-engine-native-webcache"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-native-webcache"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-native-webcache.git',
  :tag => s.version.to_s }
    ...
    s.dependency "x-engine-native-rest"
