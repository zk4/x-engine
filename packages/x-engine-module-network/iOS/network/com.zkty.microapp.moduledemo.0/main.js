...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "041c72c652244b899ff4";
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].network = _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].network || {};

_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].network.request = function (args) {
  return new Promise(function (resolve, reject) {
    const defaultConfig = {};

    try {
      const str = { ...defaultConfig,
        ...args
      };
      dsBridge.call("com.zkty.module.network.request", str, function (res) {
        resolve(res);
      });
    } catch (error) {
      reject(error);
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].network.download = function (args) {
  return new Promise(function (resolve, reject) {
    const defaultConfig = {};
    ...
    try {
      ...
      dsBridge.call("com.zkty.module.network.download", str, function (res) {
        resolve(res);
      });
    } catch (error) {
      reject(error);
...
/* harmony default export */ __webpack_exports__["default"] = (_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].network);
...
__webpack_require__(/*! /Users/edz/code/zkty/modules/x-engine-module-network/h5/node_modules/vconsole-webpack-plugin/src/vconsole.js */"./node_modules/vconsole-webpack-plugin/src/vconsole.js");
