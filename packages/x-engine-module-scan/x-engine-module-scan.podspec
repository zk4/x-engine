...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-module-scan"
    s.version      = version
    s.summary      = "x-engine-module-scan"

     s.description  = <<-DESC
            description
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-module-scan"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-module-scan.git',
  :tag => s.version.to_s }
