...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "bf6bba765e69d4f7d472";
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].camera.openCamera = function (args) {
  const alertConfig = {};
  return new Promise(function (resolve, reject) {
    try {
      ...
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.camera.openCamera", str, function (res) {
        resolve(res);
      });
    } catch (error) {
      reject(error);
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].camera.handleCamera = function (args) {
  return new Promise(function (resolve, reject) {
    try {
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.register('handleCamera', res => {
