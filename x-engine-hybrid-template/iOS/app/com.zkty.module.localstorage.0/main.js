...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "73f777737e3f5d16cf25";
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].localStorage = _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].localStorage || {}; // set userDefault

_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].localStorage.setLocalStorage = function (args) {
  const setConfig = {};
  return new Promise((resolve, reject) => {
    try {
      if (!args) {
        alert('setLocalStorage参数错误');
      } else {
        if (args.hasOwnProperty('key') && args.hasOwnProperty('data')) {
          const obj = { ...setConfig,
            ...args
          };
          _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.localStorage.setLocalStorage", obj, function (res) {
          ...
          if (args.hasOwnProperty('fail')) {
            args.fail("setLocalStorage参数错误");
          } else {
            reject("setLocalStorage参数错误");
          }
        }
      }
    } catch (error) {}
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].localStorage.getLocalStorage = function (args) {
  if (!args) {
    alert('getLocalStorage参数错误');
  } else {
    const obj = {
      key: args
    };
    return _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.localStorage.getLocalStorage", obj, function (res) {
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].localStorage.removeLocalStorage = function (args) {
  const removeConfig = {};
  return new Promise((resolve, reject) => {
    try {
      if (!args) {
        alert('removeLocalStorage参数错误');
      } else {
        if (args.hasOwnProperty('key')) {
          const obj = { ...removeConfig,
            ...args
          };
          _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.localStorage.removeLocalStorage", obj, function (res) {
            if (args.hasOwnProperty('success')) {
              args.success(JSON.parse(res));
            } else {
              resolve(JSON.parse(res));
          ...
          if (args.hasOwnProperty('fail')) {
            args.fail("removeLocalStorage参数不正确");
          } else {
            reject("removeLocalStorage参数不正确");
          }
        }
      }
    } catch (error) {}
...
/* harmony default export */ __webpack_exports__["default"] = (_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].localStorage);
...
__webpack_require__(/*! /Users/chenwuzheng/Code/ZKTY/modules/x-engine-module-localStorage/h5/node_modules/vconsole-webpack-plugin/src/vconsole.js */"./node_modules/vconsole-webpack-plugin/src/vconsole.js");
