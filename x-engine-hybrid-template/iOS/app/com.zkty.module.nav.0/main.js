...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "9746d2682cd3c19dad57";
...
/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_index_css__WEBPACK_IMPORTED_MODULE_2__);
 // 如果要让 webpack 帮助打包 img，需要这样写



_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav = _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav || {}; // 设置导航条的title

_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav.setNavTitle = function (args) {
  const navTitleConfig = {
    titleSize: 16,
    titleColor: "#000000"
  };
  return new Promise(function (resolve, reject) {
    try {
      if (!args) {
        alert("setNavTitle参数不正确");
      } else {
        if (args.hasOwnProperty("title") && args.title.length != 0) {
          const obj = { ...navTitleConfig,
            ...args
          };
          _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.nav.setNavTitle", obj, res => {
          ...
          if (args.hasOwnProperty('fail')) {
            args.fail("setNavTitle参数不正确");
          } else {
            reject("setNavTitle参数不正确");
          }
        }
      }
    } catch (error) {}
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav.setNavLeftBtn = function (args) {
  const navLeftBtnConfig = {
    titleSize: 16,
    titleColor: '#000000',
    iconSize: [20, 20]
  };
  return new Promise(function (resolve, reject) {
    try {
      if (!args) {
        alert("setNavLeftBtn参数不正确");
      } else {
        // if (args.hasOwnProperty("title") && args.title.length != 0) {
        const obj = { ...navLeftBtnConfig,
          ...args
        };
        _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.nav.setNavLeftBtn", obj, res => {
          if (args.hasOwnProperty('success')) {
            args.success(JSON.parse(res));
          } else {
            resolve(JSON.parse(res));
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav.setNavRightBtn = function (args) {
  const navRightBtnConfig = {
    titleSize: 16,
    titleColor: '#000000',
    iconSize: [20, 20]
  };
  return new Promise(function (resolve, reject) {
    try {
      if (!args) {
        alert("setNavRightBtn参数不正确");
      } else {
        // if (args.hasOwnProperty("title") && args.hasOwnProperty("icon")) {
        const obj = { ...navRightBtnConfig,
          ...args
        };
        _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.nav.setNavRightBtn", obj, res => {
          if (args.hasOwnProperty('success')) {
            args.success(JSON.parse(res));
          } else {
            resolve(JSON.parse(res));
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav.handleNavLeftBtn = function (args) {
  return new Promise(function (resolve, reject) {
    try {
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.register('handleNavLeftBtn', res => {
        if (args.hasOwnProperty('success')) {
          args.success(JSON.parse(res));
        } else {
          resolve(JSON.parse(res));
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav.handleNavRightBtn = function (args) {
  return new Promise(function (resolve, reject) {
    try {
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.register('handleNavRightBtn', res => {
        if (args.hasOwnProperty('success')) {
          args.success(JSON.parse(res));
        } else {
          resolve(JSON.parse(res));
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav.setNavRightMenuBtn = function (args) {
  const rightMenuBtnConfig = {
    titleSize: 16,
    titleColor: '#000000',
    menuWidth: '100'
  };
  return new Promise(function (resolve, reject) {
    try {
      const obj = { ...rightMenuBtnConfig,
        ...args
      };
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.nav.setNavRightMenuBtn", obj, res => {
        if (args.hasOwnProperty('success')) {
          args.success(JSON.parse(res));
        } else {
          resolve(JSON.parse(res));
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav.handleNavRightMenuBtn = function (args) {
  return new Promise(function (resolve, reject) {
    try {
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.register('handleNavRightMenuBtn', res => {
        if (args.hasOwnProperty('success')) {
          args.success(JSON.parse(res));
        } else {
          resolve(JSON.parse(res));
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav.setNavRightMoreBtn = function (args) {
  const rightMoreBtnConfig = {};
  return new Promise(function (resolve, reject) {
    try {
      const obj = { ...rightMoreBtnConfig,
        ...args
      };
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.nav.setNavRightMoreBtn", obj, res => {
        if (args.hasOwnProperty('success')) {
          args.success(JSON.parse(res));
        } else {
          resolve(JSON.parse(res));
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav.handleNavRightMoreBtn = function (args) {
  return new Promise(function (resolve, reject) {
    try {
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.register('handleNavRightMoreBtn', res => {
        if (args.hasOwnProperty('success')) {
          args.success(JSON.parse(res));
        } else {
          resolve(JSON.parse(res));
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav.navigatorPush = function (args) {
  return new Promise(function (resolve, reject) {
    try {
      const obj = { ...args
      };
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.nav.navigatorPush", obj, res => {
        if (args.hasOwnProperty('success')) {
          args.success(JSON.parse(res));
        } else {
          resolve(JSON.parse(res));
...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav.navigatorBack = function (args) {
  return new Promise(function (resolve, reject) {
    try {
      const obj = { ...args
      };
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.nav.navigatorBack", obj, res => {
        if (args.hasOwnProperty('success')) {
          args.success(JSON.parse(res));
        } else {
          resolve(JSON.parse(res));
...
/* harmony default export */ __webpack_exports__["default"] = (_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].nav);
...
__webpack_require__(/*! /Users/chenwuzheng/Code/ZKTY/modules/x-engine-module-nav/h5/node_modules/vconsole-webpack-plugin/src/vconsole.js */"./node_modules/vconsole-webpack-plugin/src/vconsole.js");
