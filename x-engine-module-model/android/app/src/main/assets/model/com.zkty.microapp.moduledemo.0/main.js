...
_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].model = _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].model || {};

_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].model.showActionSheet = function (args) {
  const alertConfig = {
    itemList: ['测试0', '测试2', '测试3', '测试4', '测试5']
  ...
  return new Promise(function (resolve, reject) {
    try {
      ...
      _zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].bridge.call("com.zkty.module.model.showActionSheet", JSON.stringify(str), function (res) {
        resolve(res);
      });
    } catch (error) {
      reject(error);
...
/* harmony default export */ __webpack_exports__["default"] = (_zk4_xengine__WEBPACK_IMPORTED_MODULE_0__["default"].model);
