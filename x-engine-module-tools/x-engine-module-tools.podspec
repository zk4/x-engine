...
Pod::Spec.new do |s|
    ...
    s.name         = "x-engine-module-tools"
    s.version      = "1.0.0"
    s.summary      = "summary of x-engine-module-tools"

     s.description  = <<-DESC
            包含了解压缩的工具
                     DESC

    s.homepage     = "https://github.com/zkty-team/x-engine-module-tools"
    ...
    s.source      = { :git => 'https://github.com/zkty-team/x-engine-module-tools.git',
  :tag => s.version.to_s }
